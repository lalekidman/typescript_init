...
export const validFbLink = /^((((https:\/\/)?)+(www\.|m\.)?)?)+((facebook\.com\/)|(facebook.com\/)|(fb.com\/)|(prod.facebook.com\/))[a-zA-Z0-9.-?_=&/]+$/

export const validInstagramLink = /^((https:\/\/+(www\.)?)?)+(instagram\.com\/)[a-zA-Z0-9.-?_=&/]+$/
